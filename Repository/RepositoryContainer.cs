...
namespace Observable.Repository
{
    ...
    public class RepositoryContainer : IRepositoryContainer
    {
        ...
        {
            _dataProducer = dataProducer ?? new DefaultDataProducer(null);
            _iocRegister = iocRegister;
        }
        ...
        /// </summary>
        public IDataProducer DataProducer => _dataProducer;
        ...
        public IRepositoryJoinBuilder<TKey, TValue, TLeft> Build<TKey, TValue, TLeft>(
            ...
            => new RepositoryJoinBuilder<TKey, TValue, TLeft>(
                this,
        ...
        public IRepositoryContainer Register<TKey, TValue>(IRepository<TKey, TValue> repository)
        {
            ...
            lock (_mutex)
            {
                ...
                _iocRegister?.Invoke(typeof(IRepository<TKey, TValue>), repository.Name, repository);
        ...
        private struct RepositoryKey : IEquatable<RepositoryKey>
        {
            ...
            public RepositoryKey(string name, Type keyType, Type valueType)
            {
                ...
                unchecked
                {
                    ...
                    _hashCode = (_hashCode * 397) ^ _valueType.GetHashCode();
                    _hashCode = (_hashCode * 397) ^ _keyType.GetHashCode();
                }
            }
            ...
            public static IEqualityComparer<RepositoryKey> Comparer { get; } = new RepositoryKeyEqualityComparer();
